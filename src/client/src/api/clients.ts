...
export const sessionsApi = {
  ...
  respondToUiRequest: (session: SessionLookup, requestId: string, value: string, machineId = "local") => request(sessionUrl(session, "ui/respond", machineId), parseAccepted, { method: "POST", body: sessionBody(session, { requestId, value }) }),
  cancelUiRequest: (session: SessionLookup, requestId: string, machineId = "local") => request(sessionUrl(session, "ui/cancel", machineId), parseAccepted, { method: "POST", body: sessionBody(session, { requestId }) }),
